...
const Wallet = () => {
  ...
  return (
    <div className="row ">
      <div
        className="col-lg-3 mb30 cursor-pointer"
        onClick={() => handleAuthenticate(availabelProviders.metaMask)}
      >
      ...
      <div
        ...
        onClick={() => handleAuthenticate(availabelProviders.walletconnect)}
      >
        <span className="box-url">
