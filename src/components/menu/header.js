          ...
          <div className='search'>
            <input id="quick_search" className="xs-hide" name="quick_search" placeholder="search item here..." type="text" />
                        ...
                        {openMenu1 && (
                          <div className='item-dropdown'>
                            <div className="dropdown" onClick={closeMenu1}>
                              <NavLink to="/explore" onClick={() => btn_icon(!showmenu)}>NFTs by Business</NavLink>
                              <NavLink to="/explore2" onClick={() => btn_icon(!showmenu)}>NFTs by Influencers</NavLink>
                              <NavLink to="/explore2" onClick={() => btn_icon(!showmenu)}>NFTs Arabia Verified</NavLink>
                    ...
                    <div className='navbar-item'>
                      <div ref={ref1}>
                          <div className="dropdown-custom dropdown-toggle btn" 
                            ...
                            <div className='item-dropdown'>
                              <div className="dropdown" onClick={closeMenu1}>
                              <NavLink to="/explore">NFTs by Business</NavLink>
                              <NavLink to="/explore2">NFTs by Influencers</NavLink>
                              <NavLink to="/explore2">NFTs Arabia Verified</NavLink>
              ...
              <div className='mainside'>
                <NavLink to="" className="btn-main"  onClick={() => handleAuthenticate(availabelProviders.metaMask)}>Connect Wallet</NavLink>
              </div>
